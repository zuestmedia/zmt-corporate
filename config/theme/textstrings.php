  ...
  /**
    ...
    */
    ...
    function __construct(){
      ...
      //modCommentsForm
      $this->comment_privacy_policy =           __( 'By using the comment function, you hereby accept our %1$s.', 'zmt-corporate' );
      $this->comment_privacy_policy_url_title = __( 'Privacy Policy', 'zmt-corporate' );
